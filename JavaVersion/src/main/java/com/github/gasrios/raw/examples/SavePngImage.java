...
public class SavePngImage extends DngProcessor<ImageCIEXYZ> {
	...
	public static void main(String[] args) throws Exception {
		new TiffProcessorEngine(new FileInputStream("src/main/resources/raw_images/single1/1.dng"),
								new SavePngImage("src/main/resources/raw_images/single1/1.png")).run();
	}
